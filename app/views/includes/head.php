...
<head>
  ...
  <title><?php echo SITENAME; ?> &mdash; Polres</title>
  ...
  <!-- Template CSS -->
  <link rel="stylesheet" href="<?php echo URLROOT ?>/public/css/style-stisla.css">
  ...
  <!-- this font awesome for datetimepicker icon -->
