        ...
        <section class="section">
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
              <form action="<?php echo URLROOT ?>/residents/create" method="POST">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                        ...
                        data-target="#datetimepicker1" name="tanggal_lahir"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-check">
                        <input class="form-check-input <?php echo $data['jenisKelaminError'] ?  'is-invalid' :  '' ?>" type="radio" 
